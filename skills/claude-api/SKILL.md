---
name: claude-api
description: "Build apps with the Claude API, Anthropic SDKs, or Agent SDK. TRIGGER: code imports `anthropic`/`@anthropic-ai/sdk`/`claude_agent_sdk`, or user asks to use them. NOT for `openai`/other AI SDKs, general programming, or ML/data-science tasks."
